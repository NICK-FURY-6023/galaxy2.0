...
module.exports = (player) => {
  ...
  player.events.on('playerStart', (queue, track) => {
    queue.metadata.channel.send({ embeds: [
      new EmbedBuilder({
        color: colorResolver(),
        title: '<a:gb_music:1118884144848576542> Started Playing',
  ...
  player.events.on('error', (queue, error) => {
    ...
    queue.metadata.channel.send({ embeds: [
      {
        color: colorResolver(),
        title: '<a:vayu_waring:1095178559091388416> Player Error',
  ...
  player.events.on('audioTrackAdd', (queue, track) => {
    ...
    queue.metadata.channel.send({ embeds: [
      {
        color: colorResolver(),
        title: '<a:gb_DJ:1118886168134701126> Track Enqueued',
        description: `[${ escapeMarkdown(track.title) }](${ track.url })`
      }
    ] });
  });
  ...
  player.events.on('audioTracksAdd', (queue, tracks) => {
    ...
    queue.metadata.channel.send({ embeds: [
      {
        color: colorResolver(),
        title: '<a:ge_sucess:1162458509481361498> Multiple Tracks Enqueued',
  ...
  player.events.on('audioTrackRemove', (queue, track) => {
    ...
    queue.metadata.channel.send({ embeds: [
      {
        color: colorResolver(),
        title: '<a:ge_sucess:1162458509481361498> Track Removed',
        description: `[${ escapeMarkdown(track.title) }](${ track.url })`
      }
    ] });
  });
  ...
  player.events.on('audioTracksRemove', (queue, tracks) => {
    ...
    queue.metadata.channel.send({ embeds: [
      {
        color: colorResolver(),
        title: '<a:ge_sucess:1162458509481361498> Multiple Tracks Removed',
  ...
  player.events.on('playerSkip', (queue, track) => {
    ...
    queue.metadata.channel.send({ embeds: [
      {
        color: colorResolver(),
        title: '<a:ge_sucess:1162458509481361498> Player Skip',
  ...
  player.events.on('disconnect', (queue) => {
    ...
    queue.metadata.channel.send({ embeds: [
      {
        color: colorResolver(),
        title: '<a:ne_noone:1162491528942460978> Finished Playing',
  ...
  player.events.on('emptyChannel', (queue) => {
    ...
    const ctx = { embeds: [
      {
        color: colorResolver(),
        title: '<a:ne_noone:1162491528942460978> Channel Empty'
      }
    ] };
  ...
  player.events.on('emptyQueue', (queue) => {
    ...
    queue.metadata.channel.send({ embeds: [
      {
        color: colorResolver(),
        title: '<a:ne_noone:1162491528942460978> Queue Empty',
